...
class Settings(BaseSettings):
    ...
    refresh_expire_seconds: int = Field(default=7 * 24 * 3600, alias="REFRESH_EXPIRE_SECONDS")
    ...
    def require_jwt_secret(self) -> str:
        if self.jwt_secret is None:
            raise RuntimeError("JWT_SECRET is not set. Please configure it in your environment/.env.")
